    ...
    return (
        <header className="header d-flex justify-between align-center">
            <div className="header__logo d-flex align-center">
                ...
                <div className="header__text ml-10">
                    <p className="header__desc">Интернет-магазин кроссовок</p>
                </div>
            </div>
            <ul className="header__panel d-flex justify-center align-center">
                ...
                <li className="header__panel-item">
                    <svg
                        width="21"
                        height="19"
                        viewBox="0 0 21 19"
